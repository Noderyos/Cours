...
class Sudoku:
	...
	def liste_cases_vide(sudoku):
		"""
		    Retourne en sortie une liste de tuples contenant les coordonées des cases vides
		    Paramètre
		    ----------
		    sudoku : list
		    Matrice de sudoku
		    ...
		    -------
		    : list
		    Liste des coordonées des cases vides sous forme de tuple
    	"""
		cases = []
	...
	def est_dans_ligne(sudoku,index,value):
		"""
		    Retourne en sortie si value est dans la ligne d'index index
		    Paramètre
		    ----------
		    sudoku : list
		    Matrice de sudoku
	...
	def est_dans_colonne(sudoku,index,value):
		"""
		    Retourne en sortie si value est dans la colonne d'index index
		    Paramètre
		    ----------
		    sudoku : list
		    Matrice de sudoku
	...
	def est_dans_bloc(sudoku,index,value):
		"""
		    Retourne en sortie si value est dans le bloc d'index index
		    Paramètre
		    ----------
		    sudoku : list
		    Matrice de sudoku
	...
	def liste_candidats_case(sudoku,coord):
		"""
		    Retourne en sortie la liste des possibilités pour la case coord
		    Paramètre
		    ----------
		    sudoku : list
		    Matrice de sudoku
	...
	def liste_candidats(sudoku):
		"""
		    Retourne en sortie la liste des possibilités pour chaque case vide
		    Paramètre
		    ----------
		    sudoku : list
		    Matrice de sudoku
...
class Final:
	def liste_candidats(sudoku):
		i = []
		for j in Sudoku.liste_cases_vide(sudoku):
			i.append([j,Sudoku.liste_candidats_case(sudoku,j)])
		return i
